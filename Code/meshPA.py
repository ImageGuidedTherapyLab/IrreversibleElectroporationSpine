...
ActiveLength =  5.0 # mm
# TODO add conic section to tip
cubit.cmd('   webcut volume %d with plane zplane offset %f  ' % (idhealthy,-ActiveDistanceFromTip) )
cubit.cmd('   webcut volume %d with plane zplane offset %f  ' % (idhealthy, 0.0) )
...
cubit.cmd('nodeset 2 node with  z_coord < 1 in surface 90 149 178 120')
...
cubit.cmd('export mesh "meshPA%s.e" overwrite' % resolutionID)
