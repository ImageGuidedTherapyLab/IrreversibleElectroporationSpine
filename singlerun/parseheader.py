...
with open('dog1L3.ini', 'w', encoding="utf-8") as f:
    tissuereplace = "tissue_replace = %s 1 %s 2 %s 3 %s 3 %s 3 %s 4 %s 4 %s 5 %s 6  %s 6 %s 6" % (labeldictionary[1]['L3_muscle'], labeldictionary[1]['L3_bone'], labeldictionary[1]['L3_needle'], labeldictionary[1]['L3_needle_center'], labeldictionary[1]['L3_needle_end'], labeldictionary[1]['L3_muscle_tumor'],labeldictionary[1]['L3_bone_tumor'], labeldictionary[1]['L3_CSF'], labeldictionary[1]['L3_cord'], labeldictionary[1]['L3_nerve_root_left'], labeldictionary[1]['L3_nerve_root_right']) 
    voltagelist   = "voltageList = [   (2700,{'tip':%s, 'entry':%s, 'root':6, 'cord':6}) ]" % (labeldictionary[1]['L3_needle_center'], labeldictionary[1]['L3_needle_end']) 
    sedcmd        = 'sed "s/^\s\+/dog1L3,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog1L3/electric_conductivity.2700.%s.%s.txt > dog1L3/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[1]['L3_needle_center'], labeldictionary[1]['L3_needle_end'],labeldictionary[1]['L3_needle_center'], labeldictionary[1]['L3_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogone',sedcmd ))
    
with open('dog1L5.ini', 'w', encoding="utf-8") as f:
    tissuereplace = "tissue_replace = %s 1 %s 2 %s 3 %s 3 %s 3 %s 4 %s 4 %s 5 %s 6  %s 6 %s 6" % (labeldictionary[1]['L5_muscle'], labeldictionary[1]['L5_bone'], labeldictionary[1]['L5_needle'], labeldictionary[1]['L5_needle_center'], labeldictionary[1]['L5_needle_end'], labeldictionary[1]['L5_muscle_tumor'],labeldictionary[1]['L5_bone_tumor'], labeldictionary[1]['L5_CSF'], labeldictionary[1]['L5_cord'], labeldictionary[1]['L5_nerve_root_left'], labeldictionary[1]['L5_nerve_root_right']) 
    voltagelist   = "voltageList = [   (2700,{'tip':%s, 'entry':%s, 'root':6, 'cord':6}) ]" % (labeldictionary[1]['L5_needle_center'], labeldictionary[1]['L5_needle_end']) 
    sedcmd        = 'sed "s/^\s\+/dog1L5,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog1L5/electric_conductivity.2700.%s.%s.txt > dog1L5/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[1]['L5_needle_center'], labeldictionary[1]['L5_needle_end'],labeldictionary[1]['L5_needle_center'], labeldictionary[1]['L5_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogone',sedcmd ))
    
with open('dog1T11.ini', 'w', encoding="utf-8") as f:
    tissuereplace = "tissue_replace = %s 1 %s 2 %s 3 %s 3 %s 3 %s 4 %s 4 %s 5 %s 6  %s 6 %s 6" % (labeldictionary[1]['T11_muscle'], labeldictionary[1]['T11_bone'], labeldictionary[1]['T11_needle'], labeldictionary[1]['T11_needle_center'], labeldictionary[1]['T11_needle_end'], labeldictionary[1]['T11_muscle_tumor'], labeldictionary[1]['T11_bone_tumor'], labeldictionary[1]['T11_CSF'], labeldictionary[1]['T11_cord'], labeldictionary[1]['T11_nerve_root_left'], labeldictionary[1]['T11_nerve_root_right']) 
    voltagelist   = "voltageList = [   (2700,{'tip':%s, 'entry':%s, 'root':6, 'cord':6}) ]" % (labeldictionary[1]['T11_needle_center'], labeldictionary[1]['T11_needle_end']) 
    sedcmd        = 'sed "s/^\s\+/dog1T11,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog1T11/electric_conductivity.2700.%s.%s.txt > dog1T11/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[1]['T11_needle_center'], labeldictionary[1]['T11_needle_end'], labeldictionary[1]['T11_needle_center'], labeldictionary[1]['T11_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogone',sedcmd ))
    
with open('dog1T12.ini', 'w', encoding="utf-8") as f:
    tissuereplace = "tissue_replace = %s 1 %s 2 %s 3 %s 3 %s 3 %s 4 %s 5 %s 6  %s 6 %s 6" % (labeldictionary[1]['T12_muscle'], labeldictionary[1]['T12_bone'], labeldictionary[1]['T12_needle'], labeldictionary[1]['T12_needle_center'], labeldictionary[1]['T12_needle_end'], labeldictionary[1]['T12_bone_tumor'], labeldictionary[1]['T12_CSF'], labeldictionary[1]['T13_cord'], labeldictionary[1]['T12_nerve_root_left'], labeldictionary[1]['T12_nerve_root_right']) 
    voltagelist   = "voltageList = [   (2700,{'tip':%s, 'entry':%s, 'root':6, 'cord':6}) ]" % (labeldictionary[1]['T12_needle_center'], labeldictionary[1]['T12_needle_end']) 
    sedcmd        = 'sed "s/^\s\+/dog1T12,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog1T12/electric_conductivity.2700.%s.%s.txt > dog1T12/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[1]['T12_needle_center'], labeldictionary[1]['T12_needle_end'],labeldictionary[1]['T12_needle_center'], labeldictionary[1]['T12_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogone',sedcmd ))
...
with open('dog2L1.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog2L1,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog2L1/electric_conductivity.2700.%s.%s.txt > dog2L1/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[2]['L1_needle_midpoint'], labeldictionary[2]['L1_needle_end'],labeldictionary[2]['L1_needle_midpoint'], labeldictionary[2]['L1_needle_end'])
...
with open('dog2L3.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog2L3,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog2L3/electric_conductivity.2700.%s.%s.txt > dog2L3/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[2]['L3_needle_midpoint'], labeldictionary[2]['L3_needle_end'],labeldictionary[2]['L3_needle_midpoint'], labeldictionary[2]['L3_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogtwo',sedcmd ))
...
with open('dog2L5.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog2L5,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog2L5/electric_conductivity.2700.%s.%s.txt > dog2L5/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[2]['L5_needle_midpoint'], labeldictionary[2]['L5_needle_end'],labeldictionary[2]['L5_needle_midpoint'], labeldictionary[2]['L5_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogtwo',sedcmd ))
...
with open('dog2T12.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog2T12,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog2T12/electric_conductivity.2700.%s.%s.txt > dog2T12/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[2]['T12_needle_midpoint'], labeldictionary[2]['T12_needle_end'],labeldictionary[2]['T12_needle_midpoint'], labeldictionary[2]['T12_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogtwo',sedcmd ))
...
with open('dog3L3.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog3L3,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog3L3/electric_conductivity.2700.%s.%s.txt > dog3L3/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[3]['L3_needle_center'], labeldictionary[3]['L3_needle_end'],labeldictionary[3]['L3_needle_center'], labeldictionary[3]['L3_needle_end'])
...
with open('dog3L5.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog3L5,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog3L5/electric_conductivity.2700.%s.%s.txt > dog3L5/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[3]['L5_needle_center'], labeldictionary[3]['L5_needle_bottom'],labeldictionary[3]['L5_needle_center'], labeldictionary[3]['L5_needle_bottom'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogthree',sedcmd ))
...
with open('dog3T12.ini', 'w', encoding="utf-8") as f:
    ...
    sedcmd        = 'sed "s/^\s\+/dog3T12,/g;s/\s\+/,/g;s/LabelID/InstanceUID,LabelID/g;s/Vol(mm^3)/Vol.mm.3/g;s/Extent(Vox)/ExtentX,ExtentY,ExtentZ/g"  dog3T12/electric_conductivity.2700.%s.%s.txt > dog3T12/electric_conductivity.2700.%s.%s.csv' %(labeldictionary[3]['T12_needle_center'], labeldictionary[3]['T12_needle_end'],labeldictionary[3]['T12_needle_center'], labeldictionary[3]['T12_needle_end'])
    f.write(initemplate %(tissuereplace, voltagelist, 'dogthree',sedcmd ))
